defmodule PlatformWeb.UserLiveTest do
  use PlatformWeb.ConnCase

  import Phoenix.LiveViewTest
  import Platform.IAMFixtures

  @create_attrs %{password: "some password", nickname: "some nickname", email: "some email", remember_me: true}
  @update_attrs %{password: "some updated password", nickname: "some updated nickname", email: "some updated email", remember_me: false}
  @invalid_attrs %{password: nil, nickname: nil, email: nil, remember_me: false}
