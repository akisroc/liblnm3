defmodule Platform.Shared.Infrastructure.Persistence.Schemas.User do
  use Ecto.Schema
  import Ecto.Changeset

  alias Platform.Shared.Infrastructure.Persistence.Schemas.{Session, Kingdom, Protagonist}
