defmodule Platform.Shared.Infrastructure.Persistence.Schemas.Kingdom do
  use Ecto.Schema
  import Ecto.Changeset

  alias Platform.Shared.Infrastructure.Persistence.Schemas.{User, Protagonist}
  alias Platform.Shared.Infrastructure.Persistence.Types.{UUID7, Slug, Troop}

  @type t :: %__MODULE__{
    id: Striing.t() | nil,
    user_id: Striing.t() | nil,
    leader_id: Striing.t() | nil,
    name: String.t() | nil,
    slug: String.t() | nil,
    fame: Decimal.t() | nil,
