defmodule Platform.Sovereignty.Infra.Persistence.Postgres.Schemas.Notable do
  use Ecto.Schema
  import Ecto.Changeset

  alias Platform.Shared.Infra.Persistence.Postgres.Types.{UUID7, LoreName, Slug, Url}
  alias Platform.Sovereignty.Infra.Persistence.Postgres.Schemas.{Player, Kingdom}
