defmodule Platform.Sovereignty.Infra.Postgres.Schemas.Battle do
  ...
  def register(battle, attrs) do
    ...
    |> check_constraint(:attacker_initial_troop,
      name: :chk_battles_attacker_initial_troop_integrity
    )
    |> check_constraint(:defender_initial_troop,
      name: :chk_battles_defender_initial_troop_integrity
    )
