defmodule Platform.Sovereignty.Types.BattleState do
  @moduledoc false
  ...
  @doc false
  @spec update_salvo_units(__MODULE__.t(), Unit.t(), Unit.t(), non_neg_integer()) ::
          __MODULE__.t()
  ...
  @doc false
  @spec add_salvo_log_entry(__MODULE__.t(), Unit.t(), Unit.t(), [non_neg_integer()]) ::
          __MODULE__.t()
