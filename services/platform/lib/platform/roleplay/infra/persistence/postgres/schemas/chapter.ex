defmodule Platform.Roleplay.Infra.Persistence.Postgres.Schemas.Chapter do
  use Ecto.Schema
  import Ecto.Changeset

  alias Platform.Roleplay.Infra.Persistence.Postgres.Schemas.{Chronicle, Protagonist}
