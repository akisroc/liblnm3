defmodule Platform.IAM.Infrastructure.Persistence.Postgres.Repositories.Identities do
  @behaviour Platform.IAM.Domain.Aggregates.Identities

  alias Ecto.Multi
  alias Phoenix.PubSub

  alias Platform.IAM.Infrastructure.Persistence.Postgres.Schemas.{User, Session}
  alias Platform.Shared.Infrastructure.Persistence.Postgres.Repo
  alias Platform.Shared.Infrastructure.Persistence.Postgres.Schemas.OutboxMessage
