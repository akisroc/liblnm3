defmodule Platform.Sovereignty.Infrastructure.Persistence.Postgres.Schemas.Battle do
  use Ecto.Schema
  import Ecto.Changeset

  alias Platform.Sovereignty.Infrastructure.Persistence.Postgres.Types.Troop
  alias Platform.Sovereignty.Infrastructure.Persistence.Postgres.Schemas.Kingdom
