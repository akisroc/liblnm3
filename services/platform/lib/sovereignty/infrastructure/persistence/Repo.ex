defmodule Platform.Sovereignty.Infrastructure.Persistence.Repo do
  alias Platform.Sovereignty.Domain.Types.Kingdom

  alias Platform.Sovereignty.Infrastructure.Persistence.Schemas.Kingdom, as: KingdomSchema
  ...
  def fetch_fighting_kingdoms!(atk_player_id, atk_player_id) do
    ...
    # atk_kingdom = %Kingdom{
      ...
      #   atk_troop: persistent_atk_kingdom.attack_troop,
      ...
      #   def_troop: persistent_def_kingdom.defense_troop,
