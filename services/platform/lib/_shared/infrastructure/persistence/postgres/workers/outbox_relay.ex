defmodule Platform.Shared.Infrastructure.Persistence.Postgres.Outbox.Relay do
  use GenServer
  require Logger
  import Ecto.Query

  alias Platform.Shared.Infrastructure.Persistence.Postgres.{Repo, OutboxPublisher}
