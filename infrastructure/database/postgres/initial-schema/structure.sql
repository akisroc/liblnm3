...
CREATE UNIQUE INDEX "idx_leader_id_kingdom_id" ON "protagonists" ("id", "kingdom_id");
...
-- FUNCTIONS
COMMENT ON FUNCTION is_valid_troop(integer[]) IS 'A troop must be a flat list of 8 postive integers';
...
-- PROCEDURES
COMMENT ON PROCEDURE register_kingdom_and_leader(uuid, uuid, uuid, varchar, varchar, varchar, varchar)
